...
bool is_palindrome(const std::string& the_string) {
    // size of the string
    ...
    string::const_iterator it = the_string.begin();
    // the reverse iterator to get the characters starting from the end
    string::const_reverse_iterator rev_it = the_string.rbegin();
